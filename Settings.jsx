    ...
    <div className="w-full max-w-2xl flex flex-col gap-4 max-h-[85vh] overflow-y-auto pr-1">
      ...
      <div className="bg-card border border-border rounded-xl p-5">
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center justify-between"><span className="text-xs font-body text-muted-foreground">Hitboxes (all fight objects/attacks):</span><Toggle on={local.hitboxes === true} onClick={() => apply({ hitboxes: local.hitboxes !== true })} /></div>
